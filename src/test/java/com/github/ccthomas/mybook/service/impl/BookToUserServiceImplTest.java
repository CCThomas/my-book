...
public class BookToUserServiceImplTest {
    ...
    public void create_alreadyExisting() {
        ...
        when(bookToUserRepository.existsByBookIdAndUserIdAndRoleId(bookId, userId, roleId)).thenReturn(true);when(bookToUserRepository.save(any())).thenReturn(bookToUser);
